...
android {
    namespace = "com.mintwise.expense"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.mintwise.expense"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "0.1.0"
    ...
    buildTypes {
        release {
            ...
            // Use the real release keystore when CI provides one; otherwise
            // fall back to the debug keystore so the APK is installable.
